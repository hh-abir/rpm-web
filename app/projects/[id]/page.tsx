    ...
    <main className="min-h-screen bg-[#050505] text-white pt-24 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="mb-8">
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 text-xs font-mono text-neutral-500 hover:text-blue-400 transition-colors uppercase tracking-wider"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-blue-500 font-mono text-sm tracking-widest uppercase mb-6">
            ...
            <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
              <div className="flex gap-2">
                {project.techStack.slice(0, 3).map((tech) => (
                  <span
                    key={tech}
                    className="text-[10px] font-mono bg-black/50 backdrop-blur border border-white/20 px-2 py-1 rounded text-white"
                  >
                    {tech}
                  </span>
                ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-invert max-w-none text-neutral-400 text-sm leading-7 bg-[#0a0a0a] border border-white/5 p-6 rounded-xl">
              ...
              <br />
              <p>
                <strong>Technical Objective:</strong> Developing robust autonomy
                in unstructured environments is the primary goal. This unit
                integrates advanced sensor fusion to handle variable lighting
                and terrain slippage.
              </p>
            </div>
          </div>
